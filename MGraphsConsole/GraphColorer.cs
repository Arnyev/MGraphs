...
namespace MGraphsConsole
{
    class GraphColorer
    {
        ...
        private int? _chromaticNumber = null;
        ...
        public void SaveColoringToFile(string filename)
        {
            var filecontnet = new StringBuilder();
            filecontnet.AppendLine(ChromaticNumber.ToString());
            filecontnet.AppendLine(string.Join(",", Colors));
            File.WriteAllText(filename, filecontnet.ToString());
        }
        private int[] _colors;
        public int ChromaticNumber
        {
            get
            {
                if (_chromaticNumber.HasValue)
                    return _chromaticNumber.Value;
                _chromaticNumber = Colors.Distinct().Count();
                return _chromaticNumber.Value;
            }
        }
        public int[] Colors
