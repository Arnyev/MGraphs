...
namespace MGraphsConsole
{
    class GraphAdapter
    {
        ...
        public static bool[][,] LoadGraphsFromDirectory(string directoryPath, char separator, out string errors, out string[] filenames)
        {
            List<bool[,]> graphs = new List<bool[,]>();
            List<string> filenames_out = new List<string>();
            var sb = new StringBuilder();
            ...
            errors = sb.ToString();
            filenames = filenames_out.ToArray();
